  ...
  $(document).ready(function () {
    ...
    allNextBtn.click(function () {
      var curStep = $(this).closest(".setup-content"),
        ...
        nextStepWizardBtn = nextStepWizard.attr('class'),
        isValid = true;


      if (isValid) {
        if (nextStepWizardBtn.includes('donorBtn')) {
          if ($('input[name="radio"]:checked').val() === 'yes' && $('input[name="radio1"]:checked').val() === 'yes' && $('input[name="radio2"]:checked').val() === 'yes' && $('input[name="radio3"]:checked').val() === 'yes' && $('input[name="radio4"]:checked').val() === 'yes') {
